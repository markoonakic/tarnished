...
const FIELD_PATTERNS: Record<FieldType, FieldPattern> = {
  first_name: {
    ...
    labelPatterns: [/\bfirst\s*name\b/i, /\bfname\b/i, /\bgiven\s*name\b/i, /^first$/i],
  ...
  last_name: {
    ...
    labelPatterns: [/\blast\s*name\b/i, /\blname\b/i, /\bsurname\b/i, /\bfamily\s*name\b/i, /^last$/i],
    placeholderPatterns: [/last\s*name/i, /surname/i, /e\.g\.\s*(doe|smith)/i, /^last$/i],
  ...
  full_name: {
    ...
    labelPatterns: [/\bfull\s*name\b/i, /\byour\s*name\b/i, /\bname\b/i, /\bapplicant\s*name\b/i, /\bcandidate\s*name\b/i],
    placeholderPatterns: [/full\s*name/i, /your\s*name/i, /e\.g\.\s*john\s*doe/i, /enter\s*your\s*name/i],
    namePatterns: [/full_?name/i, /applicant_?name/i, /candidate_?name/i, /user_?name/i, /^name$/i],
    idPatterns: [/full_?name/i, /applicant_?name/i, /candidate_?name/i, /user_?name/i],
  },
  email: {
  ...
  phone: {
    ...
    labelPatterns: [/\bphone\b/i, /\bmobile\b/i, /\bcell\b/i, /\btelephone\b/i, /\bcontact\s*number\b/i],
  ...
  linkedin_url: {
    ...
    labelPatterns: [/\blinkedin\b/i, /\blinked\s*in\b/i, /\blinkedin\s*(profile|url)\b/i],
...
function scoreField(
  element: HTMLInputElement | HTMLTextAreaElement
): { element: HTMLInputElement | HTMLTextAreaElement; fieldType: FieldType; score: number } | null {
...
function hasRelevantPatterns(element: HTMLInputElement | HTMLTextAreaElement): boolean {
...
function truncateToMaxLength(value: string, element: HTMLInputElement | HTMLTextAreaElement): string {
