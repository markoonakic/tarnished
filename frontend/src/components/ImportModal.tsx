      ...
      >
        <div className="flex justify-between items-center p-4 border-b border-tertiary">
          ...
          <button
            ...
            className="text-fg1 hover:bg-bg2 hover:text-fg0 p-1 rounded transition-all duration-200 ease-in-out cursor-pointer disabled:opacity-50"
          >
          ...
          {progress ? (
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 bg-tertiary border border-muted rounded text-primary focus:outline-none focus:border-aqua-bright transition-colors duration-200 ease-out"
              />
