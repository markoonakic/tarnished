        ...
        <div style={{ overflow: 'hidden' }}>
          {themes.map((theme) => (
            <button
              ...
              className={`w-full flex items-center justify-between px-4 py-2 text-fg1 text-left transition-colors duration-200 cursor-pointer ${
                theme.id === currentTheme ? 'bg-bg1 hover:bg-tertiary' : 'hover:bg-tertiary'
              }`}
            >
              <div className="flex items-center gap-3">
