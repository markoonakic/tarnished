      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          <select
            ...
            className="px-3 py-1 bg-tertiary text-primary rounded text-sm border border-muted focus:outline-none focus:border-[#8ec07c] transition-colors duration-200 ease"
          >
