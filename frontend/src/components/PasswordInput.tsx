    ...
    <div>
      ...
      <div className="relative">
        ...
        <button
          ...
          className="absolute right-2 top-1/2 -translate-y-1/2 px-3 py-1.5 bg-transparent text-fg1 hover:bg-bg3 hover:text-fg0 transition-all duration-200 ease-in-out rounded cursor-pointer"
