        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 bg-bg1 border border-transparent rounded text-fg1 placeholder-muted focus:outline-none focus:border-aqua-bright transition-all duration-200"
