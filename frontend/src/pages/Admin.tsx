          ...
          <div className="space-y-12">
            ...
            <section>
              ...
              <input
                ...
                className="w-full px-4 py-2 bg-bg2 text-fg1 border border-tertiary placeholder-muted focus:border-aqua-bright focus:outline-none transition-all duration-200 ease-in-out rounded"
              />
